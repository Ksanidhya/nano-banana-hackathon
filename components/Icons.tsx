...
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    <path d="M12 4.5c-2.4 0-4.5 1.2-5.9 3.1-.3.4-.2.9.2 1.2l1.2 1.2c.4.4 1 .4 1.4 0 .8-.8 1.9-1.3 3.1-1.3s2.3.5 3.1 1.3c.4.4 1 .4 1.4 0l1.2-1.2c.4-.3.5-.8.2-1.2C16.5 5.7 14.4 4.5 12 4.5zM8.5 12c.8 0 1.5.7 1.5 1.5s-.7 1.5-1.5 1.5-1.5-.7-1.5-1.5.7-1.5 1.5-1.5zm7 0c.8 0 1.5.7 1.5 1.5s-.7 1.5-1.5 1.5-1.5-.7-1.5-1.5.7-1.5 1.5-1.5z" />
  </svg>
);
